...
const PostJobPage: FC<PostJobPageProps> = ({}) => {
    ...
    return (
        <div>
            <div className='inline-flex items-center gap-3 cursor-pointer hover:text-primary'>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className='mt-5 space-y-6 pt-6'>
                    ...
                    <FieldInput title='Job Descriptiion' subtitle='Job Title must be describe one position'>
                    ...
                    <FieldInput title='Perks and Benefits' subtitle='Encourage more people to apply by sharing the attractive rewards and benefits you'>
